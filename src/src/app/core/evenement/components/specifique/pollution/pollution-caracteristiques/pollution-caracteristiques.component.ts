...
@Component({
  selector: 'pollution-caracteristiques',
  templateUrl: './pollution-caracteristiques.component.html',
  styleUrls: ['./pollution-caracteristiques.component.scss']
})
export class PollutionCaracteristiquesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pollutions = _.values(ModeleEvenementService.enumerations[EvenementCte.INPUT.POLLUTIONS].valeursEnumerations);
  }
}
