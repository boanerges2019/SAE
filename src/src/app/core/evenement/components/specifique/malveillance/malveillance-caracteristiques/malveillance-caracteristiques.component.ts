...
@Component({
  selector: 'malveillance-caracteristiques',
  templateUrl: './malveillance-caracteristiques.component.html',
  styleUrls: ['./malveillance-caracteristiques.component.scss']
})
export class MalveillanceCaracteristiquesComponent  implements OnInit {
  ...
  ngOnInit() {
    ...
    this.typesMalveillance = _.values(ModeleEvenementService.enumerations[EvenementCte.INPUT.TYPES_MALVEILLANCE].valeursEnumerations);
  }
}
