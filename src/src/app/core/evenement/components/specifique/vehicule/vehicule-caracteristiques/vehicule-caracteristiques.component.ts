...
@Component({
  selector: 'vehicule-caracteristiques',
  templateUrl: './vehicule-caracteristiques.component.html',
  styleUrls: ['./vehicule-caracteristiques.component.scss']
})
export class VehiculeCaracteristiquesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.causesVehiculeArrete = _.values(ModeleEvenementService.enumerations[EvenementCte.INPUT.CAUSES_VEHICULE_ARRETE].valeursEnumerations);
  }
}
