...
@Component({
  selector: 'convoi-caracteristiques',
  templateUrl: './convoi-caracteristiques.component.html',
  styleUrls: ['./convoi-caracteristiques.component.scss']
})
export class ConvoiCaracteristiquesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.typesConvoi = _.values(ModeleEvenementService.enumerations[EvenementCte.INPUT.TYPES_CONVOI].valeursEnumerations);
  }
}
