...
export class Ng2Datetime {
  ...
  static months: any[] =  [
    {fullName: 'Janvier', shortName: 'Jan'},
    {fullName: 'Février', shortName: 'Fev'},
    {fullName: 'Mars', shortName: 'Mar'},
    {fullName: 'Avril', shortName: 'Avr'},
    {fullName: 'Mai', shortName: 'Mai'},
    {fullName: 'Juin', shortName: 'Jui'},
    {fullName: 'Juillet', shortName: 'Jul'},
    {fullName: 'Aout', shortName: 'Aou'},
    {fullName: 'Septembre', shortName: 'Sep'},
    {fullName: 'Octobre', shortName: 'Oct'},
    {fullName: 'Novembre', shortName: 'Nov'},
    {fullName: 'Decembre', shortName: 'Dec'}
  ];
